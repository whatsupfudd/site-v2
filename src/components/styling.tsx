...
export function FuddleBrand() {
  return (<>
    <b className="text-primary-900 dark:text-primary-300"> Fuddle </b>
  </>)
}
...
export function PreviousPage({ destination, children }: { destination: string, children: string }) {
  return (
  <a href={destination} className="flex items-center justify-center px-4 h-10 me-3 text-base font-medium text-primary-500 bg-white border border-gray-300 rounded-lg hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-primary-400 dark:hover:bg-gray-700 dark:hover:text-white">
