...
export function getFakeAuthor() : BlogAuthor {
  return {
    name: "Elmer Azkellod"
    , description: "Thinker, Developer, Teammate"
    , urlLink: "#"
    , image: "https://flowbite.com/docs/images/people/profile-picture-2.jpg"
    , imageDesc: "Elmer Azkellod pic"
  }
}


export function BlogPostRender( { bpost } : { bpost : BlogContent }) {
  return (<>
          ...
          <header className="mb-4 lg:mb-6 not-format">
              <address className="flex items-center mb-6 not-italic">
                  <div className="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white">
                      <img className="mr-4 w-16 h-16 rounded-full" src={ bpost.author.image } alt={ bpost.author.imageDesc } />
                      <div>
                          <a href="#" rel="author" className="text-xl font-bold text-gray-900 dark:text-white">{ bpost.author.name }</a>
                          <p className="text-base text-gray-500 dark:text-gray-400">{ bpost.author.description }</p>
                          <p className="text-base text-gray-500 dark:text-gray-400"><time dateTime={ bpost.techPostDate } title={ bpost.postDate }>{ bpost.postDate }</time></p>
                      </div>
                  </div>
              </address>
